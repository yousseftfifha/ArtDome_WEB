 ...
 */
final class Version20210420143443 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cart ADD NomOeuvre VARCHAR(30) DEFAULT NULL, CHANGE id_user id_user INT DEFAULT NULL, CHANGE Quantity Quantity INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE exposition DROP code_oeuvre, CHANGE code_espace code_espace INT DEFAULT NULL, CHANGE code_artiste code_artiste INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE oeuvre CHANGE ID_Oeuvre ID_Oeuvre INT AUTO_INCREMENT NOT NULL, CHANGE ID_Artiste ID_Artiste INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE orders ADD TotalQty INT NOT NULL, CHANGE IDUser IDUser INT DEFAULT NULL, CHANGE OrderDate OrderDate VARCHAR(70) NOT NULL');
        ...
        $this->addSql('ALTER TABLE pending_orders ADD OrderID INT NOT NULL, DROP ID_PendingOrder, CHANGE Status Status VARCHAR(30) DEFAULT NULL');
        $this->addSql('ALTER TABLE pending_orders ADD CONSTRAINT FK_EB6BE05EEF06D63 FOREIGN KEY (OrderID) REFERENCES orders (OrderID)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE reservation_endroit (id_reservation INT AUTO_INCREMENT NOT NULL, idclient INT NOT NULL, matricule INT NOT NULL, date_debut DATE NOT NULL, date_fin DATE NOT NULL, date_retour VARCHAR(45) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_general_ci`, Cautionnement INT NOT NULL, prix_total VARCHAR(45) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_general_ci`, INDEX _idx (idclient), PRIMARY KEY(id_reservation)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE cart DROP NomOeuvre, CHANGE id_user id_user INT DEFAULT 0 NOT NULL, CHANGE Quantity Quantity INT DEFAULT 1 NOT NULL');
        ...
        $this->addSql('ALTER TABLE exposition ADD code_oeuvre INT NOT NULL, CHANGE code_artiste code_artiste INT NOT NULL, CHANGE code_espace code_espace INT NOT NULL');
        $this->addSql('ALTER TABLE exposition ADD CONSTRAINT exposition_ibfk_1 FOREIGN KEY (code_oeuvre) REFERENCES oeuvre (ID_Oeuvre) ON UPDATE CASCADE ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE oeuvre CHANGE ID_Oeuvre ID_Oeuvre INT NOT NULL, CHANGE ID_Artiste ID_Artiste INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE orders DROP TotalQty, CHANGE OrderDate OrderDate DATETIME NOT NULL, CHANGE IDUser IDUser INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE pending_orders DROP PRIMARY KEY');
        $this->addSql('ALTER TABLE pending_orders ADD ID_PendingOrder INT AUTO_INCREMENT NOT NULL, DROP OrderID, CHANGE Status Status VARCHAR(30) CHARACTER SET latin1 DEFAULT \'Pending\' COLLATE `latin1_swedish_ci`');
