 ...
 */
final class Version20210417212311 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE blog CHANGE Title Title VARCHAR(100) DEFAULT \',\' NOT NULL, CHANGE Categorie Categorie INT DEFAULT NULL, CHANGE Publisher Publisher VARCHAR(40) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE cart DROP FOREIGN KEY fk_oeuvre');
        $this->addSql('ALTER TABLE cart CHANGE id_user id_user INT DEFAULT NULL, CHANGE OeuvreId OeuvreId INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE categorie CHANGE DateCat DateCat DATE DEFAULT NULL, CHANGE NbreOeuvre NbreOeuvre INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE endroit CHANGE location location VARCHAR(255) DEFAULT NULL, CHANGE disponibilite disponibilite VARCHAR(30) DEFAULT NULL');
        $this->addSql('ALTER TABLE event DROP FOREIGN KEY fk_artiste');
        $this->addSql('ALTER TABLE event DROP FOREIGN KEY fk_espace');
        $this->addSql('ALTER TABLE event CHANGE code_espace code_espace INT DEFAULT NULL, CHANGE code_artiste code_artiste INT DEFAULT NULL, CHANGE image image VARCHAR(255) DEFAULT NULL, CHANGE video video VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE oeuvre CHANGE code_exposition code_exposition INT DEFAULT NULL, CHANGE ID_Artiste ID_Artiste INT DEFAULT NULL, CHANGE DateOeuvre DateOeuvre DATE DEFAULT NULL, CHANGE NomCat NomCat VARCHAR(50) DEFAULT NULL, CHANGE EmailArtiste EmailArtiste VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE orders CHANGE IDUser IDUser INT DEFAULT NULL, CHANGE OrderDate OrderDate DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
        $this->addSql('ALTER TABLE orders ADD CONSTRAINT FK_E52FFDEE3803A2E5 FOREIGN KEY (IDUser) REFERENCES user (ID)');
        $this->addSql('ALTER TABLE pending_orders DROP FOREIGN KEY fk_oeuvres');
        $this->addSql('ALTER TABLE pending_orders DROP FOREIGN KEY fk_us');
        $this->addSql('ALTER TABLE pending_orders CHANGE IDUser IDUser INT DEFAULT NULL, CHANGE InnoNumber InnoNumber INT DEFAULT NULL, CHANGE OeuvreID OeuvreID INT DEFAULT NULL, CHANGE Quantity Quantity INT DEFAULT NULL, CHANGE Status Status VARCHAR(30) DEFAULT \'Pending\'');
        ...
        $this->addSql('ALTER TABLE reservation CHANGE date_retour date_retour VARCHAR(45) DEFAULT NULL, CHANGE prix_total prix_total VARCHAR(45) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE reservation_expo CHANGE code_expo code_expo INT DEFAULT NULL, CHANGE code_client code_client INT DEFAULT NULL, CHANGE nb_place nb_place INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE reservationevent CHANGE code_client code_client INT DEFAULT NULL, CHANGE code_event code_event INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE user ADD is_verified TINYINT(1) NOT NULL, CHANGE nom nom VARCHAR(255) DEFAULT NULL, CHANGE prenom prenom VARCHAR(255) DEFAULT NULL, CHANGE email email VARCHAR(180) NOT NULL, CHANGE image image VARCHAR(80) DEFAULT NULL, CHANGE roles roles JSON NOT NULL, CHANGE password password VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE blog CHANGE Title Title VARCHAR(100) CHARACTER SET latin1 DEFAULT \'\'\',\'\'\' NOT NULL COLLATE `latin1_swedish_ci`, CHANGE Publisher Publisher VARCHAR(40) CHARACTER SET latin1 DEFAULT \'NULL\' COLLATE `latin1_swedish_ci`, CHANGE Categorie Categorie INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE cart CHANGE id_user id_user INT DEFAULT 0 NOT NULL, CHANGE OeuvreId OeuvreId INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE cart ADD CONSTRAINT fk_oeuvre FOREIGN KEY (OeuvreId) REFERENCES oeuvre (ID_Oeuvre) ON UPDATE CASCADE ON DELETE CASCADE');
        $this->addSql('ALTER TABLE categorie CHANGE DateCat DateCat DATE DEFAULT \'NULL\', CHANGE NbreOeuvre NbreOeuvre INT DEFAULT 0');
        ...
        $this->addSql('ALTER TABLE endroit CHANGE location location VARCHAR(255) CHARACTER SET latin1 DEFAULT \'NULL\' COLLATE `latin1_swedish_ci`, CHANGE disponibilite disponibilite VARCHAR(30) CHARACTER SET latin1 DEFAULT \'NULL\' COLLATE `latin1_swedish_ci`');
        ...
        $this->addSql('ALTER TABLE event CHANGE code_artiste code_artiste INT DEFAULT NULL, CHANGE code_espace code_espace INT DEFAULT NULL, CHANGE image image VARCHAR(255) CHARACTER SET latin1 DEFAULT \'NULL\' COLLATE `latin1_swedish_ci`, CHANGE video video VARCHAR(255) CHARACTER SET latin1 DEFAULT \'NULL\' COLLATE `latin1_swedish_ci`');
        ...
        $this->addSql('ALTER TABLE oeuvre CHANGE code_exposition code_exposition INT DEFAULT NULL, CHANGE DateOeuvre DateOeuvre DATE DEFAULT \'NULL\', CHANGE NomCat NomCat VARCHAR(50) CHARACTER SET latin1 DEFAULT \'NULL\' COLLATE `latin1_swedish_ci`, CHANGE EmailArtiste EmailArtiste VARCHAR(255) CHARACTER SET latin1 DEFAULT \'NULL\' COLLATE `latin1_swedish_ci`, CHANGE ID_Artiste ID_Artiste INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE orders CHANGE OrderDate OrderDate DATETIME NOT NULL, CHANGE IDUser IDUser INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE pending_orders CHANGE InnoNumber InnoNumber INT DEFAULT NULL, CHANGE Quantity Quantity INT DEFAULT NULL, CHANGE Status Status VARCHAR(30) CHARACTER SET latin1 DEFAULT \'\'\'Pending\'\'\' COLLATE `latin1_swedish_ci`, CHANGE OeuvreID OeuvreID INT DEFAULT NULL, CHANGE IDUser IDUser INT DEFAULT NULL');
        $this->addSql('ALTER TABLE pending_orders ADD CONSTRAINT fk_oeuvres FOREIGN KEY (OeuvreID) REFERENCES oeuvre (ID_Oeuvre) ON UPDATE CASCADE ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE reservation CHANGE date_retour date_retour VARCHAR(45) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_general_ci`, CHANGE prix_total prix_total VARCHAR(45) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_general_ci`');
        ...
        $this->addSql('ALTER TABLE reservation_expo CHANGE code_client code_client INT DEFAULT NULL, CHANGE code_expo code_expo INT NOT NULL, CHANGE nb_place nb_place INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE reservationevent CHANGE code_client code_client INT DEFAULT NULL, CHANGE code_event code_event INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE user DROP is_verified, CHANGE nom nom VARCHAR(30) CHARACTER SET latin1 NOT NULL COLLATE `latin1_swedish_ci`, CHANGE prenom prenom VARCHAR(30) CHARACTER SET latin1 NOT NULL COLLATE `latin1_swedish_ci`, CHANGE email email VARCHAR(30) CHARACTER SET latin1 NOT NULL COLLATE `latin1_swedish_ci`, CHANGE roles roles LONGTEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_bin`, CHANGE password password VARCHAR(50) CHARACTER SET latin1 DEFAULT \'NULL\' COLLATE `latin1_swedish_ci`, CHANGE image image VARCHAR(80) CHARACTER SET latin1 DEFAULT \'NULL\' COLLATE `latin1_swedish_ci`');
    }
}
