 ...
 */
final class Version20210422190957 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cart CHANGE id_user id_user INT DEFAULT NULL, CHANGE OeuvreId OeuvreId INT DEFAULT NULL, CHANGE Quantity Quantity INT DEFAULT 1 NOT NULL');
        ...
        $this->addSql('ALTER TABLE orders CHANGE OrderID OrderID INT AUTO_INCREMENT NOT NULL, CHANGE IDUser IDUser INT DEFAULT NULL, CHANGE OrderDate OrderDate DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');
        ...
        $this->addSql('ALTER TABLE pending_orders CHANGE Status Status VARCHAR(30) DEFAULT \'Pending\'');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cart CHANGE id_user id_user INT NOT NULL, CHANGE Quantity Quantity INT NOT NULL, CHANGE OeuvreId OeuvreId INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE orders CHANGE OrderID OrderID INT DEFAULT 0 NOT NULL, CHANGE OrderDate OrderDate VARCHAR(70) CHARACTER SET latin1 NOT NULL COLLATE `latin1_swedish_ci`, CHANGE IDUser IDUser INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE pending_orders CHANGE Status Status VARCHAR(30) CHARACTER SET latin1 DEFAULT NULL COLLATE `latin1_swedish_ci`');
