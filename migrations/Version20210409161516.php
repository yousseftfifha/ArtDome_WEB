 ...
 */
final class Version20210409161516 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cart CHANGE id_user id_user INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE orders CHANGE OrderID OrderID INT AUTO_INCREMENT NOT NULL, CHANGE IDUser IDUser INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cart CHANGE id_user id_user INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE orders CHANGE OrderID OrderID INT NOT NULL, CHANGE IDUser IDUser INT NOT NULL');
